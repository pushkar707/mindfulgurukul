...
const UserCard = ({_id,username,email,phone, setsubUsersArray, seteditUserDetails, toggleModal, navigation}) => {
  ...
  return (
    <View style={styles.card}>
      ...
      <Text style={{ ...styles.description, marginTop: 8 }}>
        <Pressable onPress={() => navigation.navigate('SubUser',{user:{username, email, phone}})} >
          <Svg
